...
const Gryffindor: React.FC = () => {
  ...
  useEffect(() => {
    const fetchDetails = async () => {
      ...
      //   `https://hogwart.paulupa.com/api/dorms/3`
      //   ); // Replace '1' with the appropriate dormId
      // const data = await response.json();
      setDetails({
        points: 200,
        students: ["Luna Lovegood", "Cho Chang", "Padma Patil", "Anna Ha", "Lily Kim"],
      });
    };
  ...
  const dormTitle = "Ravenclaw";
  const dormClass = `text-shadow-ravenclaw`;
  const bannerSrc = "https://syeongkim.github.io/madcamp_week4_front/images/ravenclaw_banner.png"
