...
const Quidditch: React.FC = () => {
  return (
    <div className="min-h-screen bg-quidditch-background bg-cover bg-center flex flex-col items-center text-center relative">
      <h1 className="font-Harry text-gradient-red fixed top-0 w-full mt-4">
        quidditch
      </h1>
      ...
      <audio
        src="https://syeongkim.github.io/madcamp_week4_front/musics/11_The_Quidditch_Match_Select.mp3"
        autoPlay
        loop
      />
    </div>
